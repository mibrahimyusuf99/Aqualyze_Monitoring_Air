...
// IDENTITAS DEVICE
// ==========================================
const char* DEVICE_ID = "Aqualyze-monitor-01"; // Ganti sesuai nama node
const char* NAMA_DEVICE = "Monitoring Kolam 1"; // Nama yang gampang dibaca manusia buat device ini
const char* LOKASI_DEVICE = "Kolam Nila A";     // Nama/label lokasi fisik device
...
void handleRoot() {
  ...
  html += "<h1>Aqualyze - " + String(NAMA_DEVICE) + "</h1>";
